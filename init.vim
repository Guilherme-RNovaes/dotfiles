...
set scrolloff=10     " Minimum number os lines to keep above and below the cursor
" set colorcolumn=100  " Draw a line at the given line to keep aware of the line size
